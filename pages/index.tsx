    ...
    <>
      ...
      <CardLayout>
        ...
        <div style={{ margin: "10px" }}>
          2021년 11월 07일 이후로, 짭고라이프는 더 이상 업데이트되지 않습니다.
          코딩은 최대한 내려놓고, 학업에 더욱 집중하고자 합니다. 급식 서비스는
          계속 사용하실 수 있습니다. Next.js 또는 Svelte(예전 프레임워크)를 다룰
          줄 아시고 짭고라이프의 개발을 이어나가길 원하시는 학생분께서는,
          인스타그램 @gyuwon112로 DM 보내주시면 인수인계 해드리겠습니다.
        </div>
      </CardLayout>
